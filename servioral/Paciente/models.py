...
class paciente(models.Model):
    ...
    document = models.ForeignKey(documento, null= True, blank= True, on_delete=models.CASCADE )
    city = models.ForeignKey(ciudad, null= True, blank= True, on_delete=models.CASCADE )
    ...
    gender = models.ForeignKey(genero, null= True, blank= True, on_delete=models.CASCADE )
